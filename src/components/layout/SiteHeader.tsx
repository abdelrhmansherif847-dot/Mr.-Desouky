...
export function SiteHeader() {
  ...
  // The header's height is content-dependent: navigation labels and the
  // wordmark wrap onto a second line as the viewport narrows, exactly as the
  // approved design does. The menu panel hangs off the header's lower edge but
  // cannot be nested inside it (see the panel's own comment), so the measured
  // height is published as a custom property for the panel to read. A
  // hard-coded offset would tuck the panel under a header that had grown.
      ...
      */}
      <div
        ...
        className={cn(
          ...
          'fixed inset-x-0 bottom-0 top-[var(--header-h,4.5rem)] z-[45] lg:hidden',
